...
![image](https://user-images.githubusercontent.com/19695435/149000037-67c8a626-0136-4777-8ed9-85ef2693a626.png)


### Описание таблиц

- **Customer** - таблица с данными о клиентах
- **City** - таблица-справочник с городами для адресов
