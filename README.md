...
![image](https://user-images.githubusercontent.com/19695435/147984938-e74db382-58ad-4c9b-a66e-96f4e9e3d06b.png)
...
- **Basket** - таблица с данными о составе корзины заказа, содержит информацию о количестве блюд и цене блюда на момент заказа
